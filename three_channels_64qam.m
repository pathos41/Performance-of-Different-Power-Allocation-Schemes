...
Gamma3_dB=Gamma2_dB+3;

%Gamma11_dB=Gamma1_dB-3;
%Gamma21_dB=Gamma11_dB+10;
%Gamma31_dB=Gamma21_dB+10;  %xx-fold gain
...
for n=1:length(Gamma1)
    ...
    a=gamma1*MMSE_64_QAM_23_new(12*gamma1/7);  %Original lower bound for external bisection
    b=gamma3*MMSE_64_QAM_23_new(12*gamma1/7);  %Original upper bound for external bisection
...
for n=1:length(Gamma1)
    ...
    C_2_1(n)=6-0.25*mean(x1);  % Capacity of 4-QAM
    %------------------------Constellation wf------------------------------
    d_4_12=[0:7;
        -1:6;
        -2:5;
    ...
    C_2_12(n)=6-0.25*mean(x12);  % Capacity of 4-QAM
    ...
    C_2_14(n)=6-0.25*mean(x14);  % Capacity of 4-QAM
end
...
for n=1:length(Gamma1)
    ...
    C_2_2(n)=6-0.25*mean(x1);  % Capacity of 4-QAM
    %------------------------Constellation wf------------------------------
    d_4_12=[0:7;
        -1:6;
        -2:5;
    ...
    C_2_22(n)=6-0.25*mean(x12);  % Capacity of 4-QAM
    %--------------------Uniform power allocation--------------------------
    d_4_14=[0:7;
        -1:6;
        -2:5;
    ...
    C_2_24(n)=6-0.25*mean(x14);  % Capacity of 4-QAM
end
%-----------------------------------p3-------------------------------------
...
for n=1:length(Gamma1)
    ...
    d_4_1=[0:7;
        ...
        -5:2;
        -6:1;
        -7:0]'*2*sqrt(p3(n)/21);  % Distance matrix
    z3=sigma3*z;
    ...
    C_2_3(n)=6-0.25*mean(x1);  % Capacity of 4-QAM
    %------------------------Constellation wf------------------------------
    d_4_12=[0:7;
        -1:6;
        -2:5;
        ...
        -5:2;
        -6:1;
        -7:0]'*2*sqrt(p_3(n)/21);  % Distance matrix
    ...
    C_2_32(n)=6-0.25*mean(x12);  % Capacity of 4-QAM
    %------------------------Stronger channel------------------------------
    d_4_13=[0:7;
        -1:6;
        -2:5;
        ...
        -5:2;
        -6:1;
        -7:0]'*2*sqrt(3/21);  % Distance matrix
    ...
    C_2_13(n)=6-0.25*mean(x13);  % Capacity of 4-QAM
    %--------------------Uniform power allocation--------------------------
    d_4_14=[0:7;
        -1:6;
        -2:5;
    ...
    C_2_34(n)=6-0.25*mean(x14);  % Capacity of 4-QAM
end
for n=1:length(Gamma1)
